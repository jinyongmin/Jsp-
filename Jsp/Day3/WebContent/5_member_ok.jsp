    ...
    <%
    		...
    		try{
    			...
    			if(conn != null){
    				...
    				//sql 문법
    				String sql ="insert into tb_member(mem_userid,mem_userpw,mem_name,mem_hp,mem_email,mem_hobby,mem_ssn1,mem_ssn2,mem_zipcode,mem_address1,mem_address2,mem_address3,mem_gender)value(?,sha2(?,256),?,?,?,?,?,?,?,?,?,?,?)";
...
<body>
			...
			<p><a href="5_login.jsp">로그인 하러가기</a></p>
			<p></p>
</body>
</html>
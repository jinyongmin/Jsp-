...
<body>
    <h2>회원가입</h2>
    <form action="./5_member_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
    <input type="hidden" name="isIdCheck" id="isIdCheck" value="n">
        ...
        <p><button>가입완료</button><input type="reset" value="다시작성" id="sample6_extraAddress"></p>   	
        <!-- 타입주면 reset 안주면 submit       input type submit?-->
    </form>
</body>
</html>
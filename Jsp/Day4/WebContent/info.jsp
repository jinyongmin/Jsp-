...
<body>
	...
	<form action="./info_ok.jsp" name="regform" id="regform" method="post"
		...
		<p>
			휴대폰번호: <input type="text" name="hp" id="hp" value="<%=mem_hp%>">
		</p>
		<p>
		...
		<p>
			성별: <label>남자<input type="radio" name="gender" value="남자"
				...
				out.print("checked");%>></label> <label>여자<input
		...
		<p>
			주민번호: <input type="text" name="ssn1" value="<%=mem_ssn1%>"> -
		...
		<p>
			참고항목: <input type="text" name="address3" id="sample6_extraAddress"
				value="<%=mem_address3%>">
		</p>
		<p>
			<button>수정완료</button>

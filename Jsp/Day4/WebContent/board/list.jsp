...
<%
	while(rs.next()){
		String b_idx = rs.getString("b_idx");	//String b_idx = rs.getString(1);
		String b_title = rs.getString("b_title");//String b_title = rs.getString(4); 잘안씀
		...
		<tr>
			...
			<%
				for(int i=1; i<=pageNums; i++){
					out.print("<a href='list.jsp?pageNum=" + i + "'>[" + i + "]</a>&nbsp;&nbsp;&nbsp;");	//get방식으로 받기 jsp?
				}
			%>
			</td>
		</tr>
